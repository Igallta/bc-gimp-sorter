...
格式:{"intent":"action|chat|roleplay|clarify","usedPendingClarification":false,"needsCatalog":true,"goal":"最终目标","constraints":{"noMove":false,"noAdd":false,"replaceExisting":false,"noStack":false,"preserveParts":[]},"operations":[{"types":["itemadd"],"targets":[123],"parts":[],"assets":["LowCage"]}],"question":""}
房间名单:${roster}
