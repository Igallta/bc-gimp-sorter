// MisakaChat v2.10.2 - BC 御坂自动回复系统
// 模块分区:
//   [Config]      L15-55   配置 + 状态
...
格式:{"intent":"action|chat|clarify","usedPendingClarification":false,"needsCatalog":true,"goal":"最终目标","constraints":{"noMove":false,"noAdd":false,"replaceExisting":false,"noStack":false,"preserveParts":[]},"operations":[{"types":["itemadd"],"targets":[123],"parts":[]}],"question":""}
房间名单:${roster}
